...
def wav_to_text_whisper(wav_path, text_dir, m_type=1):
    #whisper_bin = f'{whisper}/main'
    cmd = [f'./main_{m_type}', '-f', wav_path, '-m', model_bin, '-otxt']
    result = subprocess.run(cmd, shell=False)
